...
- **איפה הכי פלטה עכשיו** — השוואה חיה בין כל החופים השמורים (ללא בקשות נוספות — משתמש בסריקת ההתראות).
- **מפת חום שבועית** — 6 ימים × שעות אור, כל תא בצבע הדרגה שלו; רואים בשנייה מתי השבוע לצאת.
...
אין אנליטיקס ואין חשבון. הדף פונה ל-Open-Meteo (קואורדינטות החוף), Google Fonts, Nominatim/OpenStreetMap
